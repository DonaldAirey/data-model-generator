// <copyright file="RollbackUpdateRowMethod.cs" company="Dark Bond, Inc.">
...
namespace DarkBond.DataModelGenerator.UniqueIndexClass
{
    ...
    /// </summary>
    public class RollbackUpdateRowMethod : SyntaxElement
    {
        /// <summary>
        /// The name of the row.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RollbackUpdateRowMethod"/> class.
        /// </summary>
        /// <param name="uniqueConstraintSchema">The unique constraint schema.</param>
        public RollbackUpdateRowMethod(UniqueConstraintSchema uniqueConstraintSchema)
        {
            // Initialize the object.
            this.uniqueConstraintSchema = uniqueConstraintSchema;

            // This is the name of the method.
            this.Name = "RollbackUpdateRow";
            ...
            //        internal void RollbackUpdateRow(ConfigurationRow configurationRow)
            //        {
            //            <Body>
            //        }
        ...
        private BlockSyntax Body
        {
            get
            {
                ...
                //            if (configurationRow.Original.targetKeyField != configurationRow.Current.targetKeyField || configurationRow.Original.configurationIdField != configurationRow.Current.configurationIdField)
                //            {
                //                <IfKeyChangedBlock>
                //            }
                statements.Add(
                                        ...
                                        new[]
                                        {
                                            ...
                                            SyntaxFactory.XmlTextLiteral(
                                                ...
                                                string.Format(
                                                    ...
                                                    " Rejects the changes when updating a <see cref=\"{0}Row\"/> in the index.",
                                        ...
                                        SyntaxFactory.TokenList(
                                            new[]
                                            {
                                                SyntaxFactory.XmlTextLiteral(
                                                    ...
                                                    string.Format(
                                                        CultureInfo.InvariantCulture,
                                                        " <param name=\"{0}Row\">The updated <see cref=\"{1}Row\"/>.</param>",
