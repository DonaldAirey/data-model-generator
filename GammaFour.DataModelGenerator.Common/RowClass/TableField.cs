//  <copyright file="TableField.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Common.RowClass
{
    ...
    /// </summary>
    public class TableField : SyntaxElement
    {
        /// <summary>
        ...
        public TableField(TableElement tableElement)
        {
            ...
            this.Syntax = SyntaxFactory.FieldDeclaration(
                ...
                .WithModifiers(TableField.Modifiers)
                .WithLeadingTrivia(TableField.DocumentationComment);
        }
