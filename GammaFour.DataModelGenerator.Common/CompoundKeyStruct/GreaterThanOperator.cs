// <copyright file="GreaterThanOperator.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Common.CompoundKeyStruct
{
    ...
    /// <summary>
    /// Creates a method to test if one key is greater than the other.
    /// </summary>
    public class GreaterThanOperator : SyntaxElement
    {
        /// <summary>
        /// The column schema.
        /// </summary>
