// <copyright file="LessThanOperator.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Common.CompoundKeyStruct
{
    ...
    /// <summary>
    /// Creates a method to test if one key is less than the other.
    /// </summary>
    public class LessThanOperator : SyntaxElement
    {
        /// <summary>
        /// The column schema.
        /// </summary>
        ...
        public LessThanOperator(UniqueConstraintSchema uniqueConstraintSchema)
        {
                            ...
                            .WithArgumentList(
                                SyntaxFactory.ArgumentList(
                                    SyntaxFactory.SingletonSeparatedList<ArgumentSyntax>(
                                        SyntaxFactory.Argument(SyntaxFactory.IdentifierName("key2"))))),
