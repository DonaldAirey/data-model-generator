// <copyright file="AddChildRowMethod.cs" company="Dark Bond, Inc.">
...
namespace DarkBond.DataModelGenerator.ForeignIndexClass
{
    ...
    /// </summary>
    public class AddChildRowMethod : SyntaxElement
    {
        /// <summary>
        /// The name of the row.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddChildRowMethod"/> class.
        /// </summary>
        /// <param name="relationSchema">The unique constraint schema.</param>
        public AddChildRowMethod(RelationSchema relationSchema)
        {
            // Initialize the object.
            this.relationSchema = relationSchema;

            // This is the name of the method.
            this.Name = "AddChildRow";
            ...
            //        internal void AddChildRow(CustomerRow customerRow)
            //        {
            //            <Body>
            //        }
        ...
        private BlockSyntax Body
        {
            get
            {
                ...
                string parentKeyName = this.relationSchema.ParentKeyConstraint.CamelCaseName;
                statements.Add(
                    SyntaxFactory.LocalDeclarationStatement(
                        ...
                        .WithVariables(
                            SyntaxFactory.SingletonSeparatedList<VariableDeclaratorSyntax>(
                                SyntaxFactory.VariableDeclarator(SyntaxFactory.Identifier(this.relationSchema.ParentKeyConstraint.CamelCaseName))
                                .WithInitializer(
                            ...
                            .WithArgumentList(
                                SyntaxFactory.ArgumentList(
                                    SyntaxFactory.SeparatedList<ArgumentSyntax>(
                                        ...
                                        {
                                            SyntaxFactory.Argument(
                                                SyntaxFactory.IdentifierName(parentKeyName)),
                                            SyntaxFactory.Token(SyntaxKind.CommaToken),
                                            SyntaxFactory.Argument(
                                                SyntaxFactory.IdentifierName("hashSet"))
                                            .WithRefOrOutKeyword(
                                        ...
                                        new[]
                                        {
                                            ...
                                            SyntaxFactory.XmlTextLiteral(
                                                ...
                                                string.Format(
                                                    ...
                                                    " Adds a <see cref=\"{0}Row\"/> child relation.",
