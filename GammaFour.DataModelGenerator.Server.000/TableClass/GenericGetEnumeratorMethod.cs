    ...
    public class GenericGetEnumeratorMethod : SyntaxElement
    {
        ...
        public GenericGetEnumeratorMethod(TableSchema tableSchema)
        {
            ...
            .WithTypeArgumentList(
                SyntaxFactory.TypeArgumentList(SyntaxFactory.SingletonSeparatedList<TypeSyntax>(SyntaxFactory.IdentifierName(this.rowType)))
            ...
            //            <Body>
            //        }
            this.Syntax = SyntaxFactory.MethodDeclaration(returnType, SyntaxFactory.Identifier(this.Name))
