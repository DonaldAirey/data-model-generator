// <copyright file="DataServiceGenerator.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.VisualStudioPackage
{
    ...
    [ComVisible(true)]
    [Guid(PackageGuid)]
    [CodeGeneratorRegistration(typeof(DataServiceGenerator), nameof(DataServiceGenerator), "{FAE04EC1-301F-11D3-BF4B-00C04F79EFBC}", GeneratesDesignTimeSource = true)]
    [CodeGeneratorRegistration(typeof(DataServiceGenerator), nameof(DataServiceGenerator), "{9A19103F-16F7-4668-BE54-9A1E7A4F7556}", GeneratesDesignTimeSource = true)]
    [CodeGeneratorRegistration(typeof(DataServiceGenerator), nameof(DataServiceGenerator), "{694DD9B6-B865-4C5B-AD85-86356E9C88DC}", GeneratesDesignTimeSource = true)]
    [ProvideObject(typeof(DataServiceGenerator))]
    public sealed class DataServiceGenerator : BaseCodeGeneratorWithSite
    {
        /// <summary>
        /// The package identifier.
        /// </summary>
        private const string PackageGuid = "9056DA99-A47F-4EEC-9005-6569F0E43DC5";
