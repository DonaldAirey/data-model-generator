    ...
    internal class ResolveForeignKey : List<StatementSyntax>
    {
        ...
        public ResolveForeignKey(ForeignKeyElement foreignKeyElement)
        {
            ...
            this.Add(
                SyntaxFactory.LocalDeclarationStatement(
                    SyntaxFactory.VariableDeclaration(
                        SyntaxFactory.IdentifierName(this.foreignKeyElement.UniqueKey.Name + "Row"))
                    .WithVariables(
                        SyntaxFactory.SingletonSeparatedList<VariableDeclaratorSyntax>(
                            SyntaxFactory.VariableDeclarator(
                                SyntaxFactory.Identifier(this.foreignKeyElement.Name.ToCamelCase() + "Row"))
                            .WithInitializer(
                    ...
                    SyntaxFactory.ExpressionStatement(
                        SyntaxFactory.InvocationExpression(
                            SyntaxFactory.MemberAccessExpression(
                                ...
                                SyntaxFactory.IdentifierName(this.foreignKeyElement.Name.ToCamelCase() + "Row"),
