    ...
    public class DeleteOneAsyncMethod : SyntaxElement
    {
        ...
        private BlockSyntax Body
        {
            get
            {
                ...
                {
                    //            using var httpRequestMessage = new HttpRequestMessage(HttpMethod.Delete, $"rest/accounts/{account.AccountId}");
        ...
        private IEnumerable<SyntaxTrivia> LeadingTrivia
        {
            get
            {
                ...
                List<SyntaxTrivia> comments = new List<SyntaxTrivia>
                {
                    ...
                    //        /// <param name="account">An <see cref="Account"/> row to delete.</param>
                    SyntaxFactory.Trivia(
                        SyntaxFactory.DocumentationCommentTrivia(
                            SyntaxKind.SingleLineDocumentationCommentTrivia,
                            SyntaxFactory.SingletonList<XmlNodeSyntax>(
                                    ...
                                    .WithTextTokens(
                                        SyntaxFactory.TokenList(
                                            new[]
                                            {
                                                SyntaxFactory.XmlTextLiteral(
                                                    SyntaxFactory.TriviaList(SyntaxFactory.DocumentationCommentExterior(Strings.CommentExterior)),
                                                    $" <param name=\"{this.tableElement.Name.ToCamelCase()}\">A <see cref=\"{this.tableElement.Name}\"/> row to delete.</param>",
                                                    string.Empty,
                                                    SyntaxFactory.TriviaList()),
                                                SyntaxFactory.XmlTextNewLine(
                                                    SyntaxFactory.TriviaList(),
