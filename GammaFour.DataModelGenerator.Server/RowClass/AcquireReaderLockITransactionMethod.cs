// <copyright file="AcquireReaderLockITransactionMethod.cs" company="Dark Bond, Inc.">
...
namespace DarkBond.DataModelGenerator.RowClass
{
    ...
    /// <summary>
    /// Creates a method that acquires a reader lock.
    /// </summary>
    public class AcquireReaderLockITransactionMethod : CodeMemberMethod
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcquireReaderLockITransactionMethod"/> class.
        /// </summary>
        /// <param name="relationSchema">The table schema.</param>
        public AcquireReaderLockITransactionMethod(TableSchema tableSchema)
        {
            //        /// <summary>
            ...
            //        public virtual void AcquireReaderLock(ITransaction iTransaction)
            //        {
            this.Comments.Add(new CodeCommentStatement("<summary>", true));
            this.Comments.Add(new CodeCommentStatement("Acquires a reader lock for this record and adds the row to the given transaction.", true));
            this.Comments.Add(new CodeCommentStatement("</summary>", true));
            ...
            this.Statements.Add(
                new CodeMethodInvokeExpression(
                    transaction,
                    "AddLock",
                    new CodeMethodReferenceExpression(new CodeThisReferenceExpression(), "AcquireReaderLock"),
