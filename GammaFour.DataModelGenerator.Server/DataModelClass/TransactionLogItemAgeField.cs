// <copyright file="TransactionLogItemAgeField.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Server.DataModelClass
{
    ...
    /// </summary>
    public class TransactionLogItemAgeField : SyntaxElement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionLogItemAgeField"/> class.
        /// </summary>
        public TransactionLogItemAgeField()
        {
            // Initialize the object.
            this.Name = "transactionItemAge";

            //        /// <summary>
            //        /// The age of the transaction log.
            //        /// </summary>
            //        private TimeSpan transactionItemAge;
