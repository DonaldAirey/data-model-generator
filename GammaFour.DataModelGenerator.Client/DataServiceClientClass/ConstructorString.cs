// <copyright file="ConstructorString.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Client.DataServiceClient
{
    ...
    /// </summary>
    public class ConstructorString : SyntaxElement
    {
        /// <summary>
        /// The table schema.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConstructorString"/> class.
        /// </summary>
        /// <param name="xmlSchemaDocument">The table schema.</param>
        public ConstructorString(XmlSchemaDocument xmlSchemaDocument)
        {
            ...
            //        /// </summary>
            //        public DataModel(string endpointConfigurationName)
            //        {
            //        }
                        ...
                        SyntaxFactory.ArgumentList(
                            SyntaxFactory.SingletonSeparatedList<ArgumentSyntax>(
                                SyntaxFactory.Argument(
                                    SyntaxFactory.IdentifierName("endpointConfigurationName")))));
            }
        }
            ...
            get
            {
                ...
                parameters.Add(
                    SyntaxFactory.Parameter(
                        SyntaxFactory.Identifier("endpointConfigurationName"))
                    .WithType(
