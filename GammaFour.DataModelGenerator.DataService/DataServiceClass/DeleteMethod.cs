...
namespace GammaFour.DataModelGenerator.DataService.DataServiceClass
{
    ...
    public class DeleteMethod : SyntaxElement
    {
        ...
        public DeleteMethod(TableElement tableElement)
        {
            ...
            //        public void DeleteConfiguration(string configurationId, string sourceKey, string targetKey)
            //        {
            //            <Body>
            //        }
        ...
        private List<StatementSyntax> TryBlock1
        {
            get
            {
                ...
                //            this.dataModel.DeleteConfiguration(configurationId, sourceKey, targetKey);
                statements.Add(
