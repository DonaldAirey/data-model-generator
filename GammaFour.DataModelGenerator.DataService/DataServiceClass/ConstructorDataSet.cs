// <copyright file="ConstructorDataSet.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.DataService.DataServiceClass
{
    ...
    /// </summary>
    public class ConstructorDataSet : SyntaxElement
    {
        /// <summary>
        /// The data model name.
        /// </summary>
        ...
        private ParameterListSyntax Parameters
        {
            get
            {
                ...
                // DataModel dataModel
                parameters.Add(
                    SyntaxFactory.Parameter(SyntaxFactory.Identifier(this.dataModelName))
                    .WithType(SyntaxFactory.IdentifierName(this.dataModelType)));
