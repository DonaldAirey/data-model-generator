// <copyright file="MasterNamespace.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Model
{
    ...
    public class MasterNamespace
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MasterNamespace"/> class.
        /// </summary>
        ...
        public MasterNamespace(XmlSchemaDocument xmlSchemaDocument, string customToolNamespace)
        {
            // Initialize the object.
            this.xmlSchemaDocument = xmlSchemaDocument;
            this.customToolNamespace = customToolNamespace;

            // This is the master data model.
            this.xmlSchemaDocument.IsMaster = true;

            // This is the syntax of the namespace.
            this.Syntax = SyntaxFactory.NamespaceDeclaration(
                SyntaxFactory.IdentifierName(customToolNamespace + ".Master"))
