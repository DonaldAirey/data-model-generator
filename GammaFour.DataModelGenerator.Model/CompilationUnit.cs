...
namespace GammaFour.DataModelGenerator.Model
{
    ...
    public class CompilationUnit
    {
        ...
        public CompilationUnit(XmlSchemaDocument xmlSchemaDocument, string customToolNamespace)
        {
            ...
            .WithMembers(
                SyntaxFactory.List<MemberDeclarationSyntax>(
                    ...
                    {
                        new Namespace(this.xmlSchemaDocument, this.customToolNamespace).Syntax,
            ...
            .WithEndOfFileToken(
                SyntaxFactory.Token(
                    SyntaxFactory.TriviaList(
                        CompilationUnit.TrailingTrivia),
        ...
        /// </summary>
        private static IEnumerable<SyntaxTrivia> TrailingTrivia
        {
            get
            {
                // The document comment trivia is collected in this list.
