// <copyright file="PatchManyAsyncMethod.cs" company="Gamma Four, Inc.">
...
namespace GammaFour.DataModelGenerator.Model.DataModelAdapterClass
{
    ...
    /// </summary>
    public class PatchManyAsyncMethod : SyntaxElement
    {
        /// <summary>
        /// The table schema.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchManyAsyncMethod"/> class.
        /// </summary>
        /// <param name="tableElement">The unique constraint schema.</param>
        public PatchManyAsyncMethod(TableElement tableElement)
        {
            ...
            //        /// <summary>
            //        /// Patches a set of <see cref="Account"/> rows.
            //        /// </summary>
            //        /// <param name="accounts">The set of <see cref="Account"/> rows.</param>
            //        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
            //        public async Task<IEnumerable<Account>> PatchAsync(IEnumerable<Account> accounts)
            //        {
            //            <Body>
            //        }
                                ...
                                .WithTextTokens(
                                    SyntaxFactory.TokenList(
                                        new[]
                                        {
                                            ...
                                            SyntaxFactory.XmlTextLiteral(
                                                SyntaxFactory.TriviaList(SyntaxFactory.DocumentationCommentExterior(Strings.CommentExterior)),
                                                $" Patchs a set of <see cref=\"{this.tableElement.Name}\"/> rows.",
                                                string.Empty,
                                                SyntaxFactory.TriviaList()),
                                            SyntaxFactory.XmlTextNewLine(
                                                SyntaxFactory.TriviaList(),
        ...
        private List<StatementSyntax> IfAnyBlock
        {
            get
            {
                ...
                var statements = new List<StatementSyntax>
                {
                    //                using var request = new HttpRequestMessage(HttpMethod.Patch, "dataModel/accounts");
